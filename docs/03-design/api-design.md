...
| パラメータ | 型 | 必須 | デフォルト | 説明 |
|-----------|-----|------|-----------|------|
| period | string | - | `month` | `month` \| `year` \| `all` |
| year | number | - | 今年 | 対象年（period=month, year 時） |
| month | number | - | 今月 | 対象月（period=month 時、1〜12） |
...
| period | year | month | 取得範囲 |
|--------|------|-------|---------|
| `month` | 2026 | 2 | 2026年2月 |
| `month` | 省略 | 省略 | 今年今月 |
| `year` | 2026 | - | 2026年全体 |
| `year` | 省略 | - | 今年全体 |
| `all` | - | - | 全期間 |
...
| period | string | - | `month` | `month` \| `year` \| `all` |
| year | number | - | 今年 | 対象年 |
| month | number | - | 今月 | 対象月（period=month 時） |

期間パラメータの組み合わせは支出一覧取得と同一。
